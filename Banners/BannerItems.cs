...
namespace StormDiversSuggestions.Banners          //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    ...
    public class HellMiniBossBannerItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.rare = ItemRarityID.Blue;
            item.value = Item.sellPrice(0, 0, 2, 0);
            item.createTile = mod.TileType("HellMiniBossBannerPlace");  //This defines what type of tile this item will place	
            item.placeStyle = 0;
        }
    }
    public class IceCoreBannerItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.rare = ItemRarityID.Blue;
            item.value = Item.sellPrice(0, 0, 2, 0);
            item.createTile = mod.TileType("IceCoreBannerPlace");  //This defines what type of tile this item will place	
            item.placeStyle = 0;
        }
    }
    public class SandCoreBannerItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.rare = ItemRarityID.Blue;
            item.value = Item.sellPrice(0, 0, 2, 0);
            item.createTile = mod.TileType("SandCoreBannerPlace");  //This defines what type of tile this item will place
            item.placeStyle = 0;
        }
    }
